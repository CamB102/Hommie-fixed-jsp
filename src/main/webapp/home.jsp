            ...
            <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h1 class="display-3 text-white mb-4 animated slideInDown">Looking for a flatmate?</h1>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Landlord</a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Student</a>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h1 class="display-3 text-white mb-4 animated slideInDown">Finding a room near your campus?</h1>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Landlord</a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Student</a>
                            </div>
                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="date" id="date1" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            placeholder="Available date" data-target="#date1" data-toggle="datetimepicker" />
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">Hommie</span></h1>
                        <p class="mb-4">Australia's biggest share accommodation website for students. <br> Where thousands of landlords and students find their perfect rommies. </p></p>
						...
						<div class="room-item shadow rounded overflow-hidden">
							...
							<div class="p-4 mt-2">
								...
								<div class="d-flex justify-content-between">
									<a class="btn btn-sm btn-primary rounded py-2 px-4" href="room?roomId=${room.id}">View
