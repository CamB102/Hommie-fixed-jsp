...
<div class="container-fluid">
    <div class="row">
      ...
      <!-- Indicators -->
                ...
                <div class="carousel-inner">
                    ...
                    <img class="img-fluid" src="img/kitchen.jpeg" style="width:100%;">
                    </div>
            
                    <div class="item">
                    <img class="img-fluid" src="img/bathroom.jpeg" style="width:100%;">
                    </div>
                
                    <div class="item">
                    <img class="img-fluid" src="img/bedroom.jpeg" style="width:100%;">
                    </div>

                    <div class="item">
                        <img class="img-fluid" src="img/livingroom.png" style="width:100%;">
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-6" style="background-color:rgb(240, 244, 248);">
        <div class="d-flex justify-content-between mb-3">
            <h3 class="mb-0">109 Lonsdale, Melbourne, VIC 3000</h3>
            <div class="ps-2">
            </div>
        </div>
        ...
        <div>
            <h4><strong>$320 per week</strong></h4>
            <p><strong>Bond</strong> $1,500</p>
            <p><strong>Available</strong> 12 Jun 2023</p>
        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp pb-5" data-wow-delay="0.1s">
                    <h1 class="mb-5">Get In Touch, <span class="text-primary text-uppercase">Hommie</span></h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <h3>Impressive, Prominent and Convenient</h3>
                            <p>
                                This impressive family home with city skyline views showcases a modern lifestyle living in a prominent, convenient location. Beautifully presented living and separate dining spaces, each of generous size, are complemented by a well-lit gourmet kitchen with granite surfaces, glass splashbacks, stainless steel appliances, and dual dishwasher drawers.
                            </p>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating date" id="date3">
                                            <input type="text" class="form-control datetimepicker-input" id="checkin" placeholder="Move In" data-target="#date3" data-toggle="datetimepicker" />
                                            <label for="checkin">Contact Number</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-floating date" id="date4" data-target-input="nearest">
                                            ...
                                            <label for="checkout">Available Date</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            ...
                                            <label for="select3">What's your enquiry about?</label>
                                          </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
        ...
        <!-- Footer Start -->
        <div class="container-fluid bg-dark text-light footer wow fadeIn mt-lg-5" data-wow-delay="0.1s">
            <div class="container pb-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@hommie.com</p>
